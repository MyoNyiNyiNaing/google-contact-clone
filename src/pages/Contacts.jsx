...
const Contacts = () => {
    ...
    return (
      <>
        ...
        <div
          ...
          className=" z-50 fixed bottom-8 right-8 lg:hidden p-3 rounded-full cursor-pointer"
          style={{
            boxShadow:
  ...
  return (
    <>
      ...
      <div className=" p-5 pb-0 space-y-4 text-[--text-color]">
        {/* top bar  */}
        ...
        <div className=" flex items-center justify-between gap-10 text-[12px] font-[500]">
          <h4 className="uppercase">Contact ({data?.contacts?.total || 0})</h4>
          <div className=" max-md:hidden">
            <Pagination
              nextIcon={MdOutlineKeyboardDoubleArrowRight}
              previousIcon={MdOutlineKeyboardDoubleArrowLeft}
              value={activePage}
              onChange={setPage}
          ...
          <div className=" max-md:hidden">
            Showing {data?.contacts?.from} - {data?.contacts?.to} of{" "}
            {data?.contacts?.total} results
          </div>
        </div>
